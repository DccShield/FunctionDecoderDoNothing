...
//--------------------------------------------------------------------------------
// 2020/12/02 add {CV_29_CONFIG, 128 },
//
#include <arduino.h>
#include "DccCV.h"
#include "NmraDcc.h"

#define PB0_OUT DDRB |= (1<<0)
#define PB0_HIGH PORTB |= (1<<0)
#define PB0_LOW  PORTB &= ~(1<<0)

#define PB1_OUT DDRB |= (1<<1)
#define PB1_HIGH PORTB |= (1<<1)
#define PB1_LOW  PORTB &= ~(1<<1)

#define PB2_OUT DDRB |= (1<<2)
#define PB2_HIGH PORTB |= (1<<2)
#define PB2_LOW  PORTB &= ~(1<<2)

#define PB3_OUT DDRB |= (1<<3)
#define PB3_HIGH PORTB |= (1<<3)
#define PB3_LOW  PORTB &= ~(1<<3)
